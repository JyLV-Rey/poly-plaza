      ...
      <div className="min-h-screen min-w-screen bg-gray-50 pt-20">
        <div className="w-full flex flex-col px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          ...
          <div className="flex justify-end space-x-4">
            <button disabled={!canCancel} className={`font-bold py-2 px-4 rounded ${canCancel ? "bg-red-500 hover:bg-red-100 hover:text-red-700 duration-300 hover:scale-105 ease-[var(--my-beizer)] border-red-700 hover:border-2 cursor-pointer" : "cursor-not-allowed bg-neutral-600 text-neutral-400"}`}>Cancel</button>
            <button disabled={!canRefund} className={`font-bold py-2 px-4 rounded ${canRefund ? "bg-amber-500 hover:bg-amber-100 hover:text-amber-700 duration-300 hover:scale-105 ease-[var(--my-beizer)] border-amber-700 cursor-pointer hover:border-2" : "cursor-not-allowed bg-neutral-600 text-neutral-400"}`}>Refund</button>
          </div>
        </div>
      </div>
    </CheckCredentials>
